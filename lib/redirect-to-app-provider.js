	...
	.provider( "AppRedirect", [ function ()
	{
		...
		var AppRedirectService = function ( iPadUrl, iPhoneUrl, redirectFrame )
		{
			...
			*/
			...
			{
			  if(-1 != window.location.href.search('no_redirect')) return;
        ...
        if(-1 == window.location.href.search('no_redirect')) {
          var separator = ((-1 == window.location.href.search(/\?/)) ? '?' : '&');
          window.location.href = window.location.href + separator + 'no_redirect=true';
        }
			};
